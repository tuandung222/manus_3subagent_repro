...
- Source structure plan: [`plans/CODE_STRUCTURE_PLAN.md`](plans/CODE_STRUCTURE_PLAN.md)
- Tracing to training data plan: [`plans/TRAINING_DATA_TRACING_PLAN.md`](plans/TRAINING_DATA_TRACING_PLAN.md)
